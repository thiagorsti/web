...
//	}
//
//	public ItemRequisicao(Servico servico, BigDecimal dimensao) {
//		setServico(servico);
...
//					setDimensao(new BigDecimal(0));
//				else if (getDimensao() == null || getDimensao().doubleValue() == 0)
//					setDimensao(new BigDecimal(1));
//			}
//		}
//	}
//
...
//		return areaChapada.getArea().doubleValue() * getAreaChapada().getPorcentagem().doubleValue() / 100 * getValorAreaChapadaServico().doubleValue();
//	}
//
